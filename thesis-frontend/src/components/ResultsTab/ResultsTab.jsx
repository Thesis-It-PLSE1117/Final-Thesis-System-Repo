  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Iteration Adjustment Notification */}
              ...
              <div>
                ...
                <p className="text-blue-700 text-sm mt-1">
                  {eacoResults?.adjustmentMessage || epsoResults?.adjustmentMessage || 
                   `Iterations were adjusted from ${eacoResults?.originalIterations || epsoResults?.originalIterations} to ${eacoResults?.iterations || epsoResults?.iterations} to ensure statistical validity (minimum 30 required for paired t-test).`}
                </p>
              </div>
            </div>
          </motion.div>
