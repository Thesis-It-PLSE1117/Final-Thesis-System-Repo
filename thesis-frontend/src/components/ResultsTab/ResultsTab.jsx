...
const ResultsTab = ({
          ...
          >
            {onNavigateToHelp && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-200 rounded-lg p-4"
              >
  ...
  const renderEChartsPlots = () => {
    ...
    if (import.meta.env.DEV) {
      validateEChartsData(eacoResults.rawResults, "EACO");
      validateEChartsData(epsoResults.rawResults, "EPSO");
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold text-[#319694]">
            Simulation Results
            {isSingleIteration && (
              <span className="ml-2 bg-blue-100 text-blue-800 text-sm px-2 py-1 rounded-full font-medium">
                Single Iteration
              </span>
            )}
          </h2>
