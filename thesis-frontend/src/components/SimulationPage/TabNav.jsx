  ...
  return (
    <div className="relative">
      ...
      <div className="lg:hidden">
        <button
          className="w-full flex items-center justify-between p-3 border-b border-gray-200 bg-white"
        ...
        >
          <div className="flex items-center gap-2">
            <ActiveIcon size={ICON_SIZES.sm} aria-hidden="true" />
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  role="menuitem"
                  className={`
                    w-full py-2.5 px-5 font-medium text-sm flex items-center gap-2 transition-colors
                    ${
                      isActive
                ...
                >
                  <Icon size={ICON_SIZES.sm} aria-hidden="true" />
                  {tab.label}
                </button>
              );
            })}
      ...
      <div
        className="hidden lg:flex border-b border-gray-200 px-4"
        role="tablist"
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              id={`${tab.id}-tab`}
              className={`
                py-3 px-5 font-medium text-sm flex items-center gap-2 transition-colors
                ${
                  isActive
