            ...
            >
              ...
              >
                ...
                <p className="text-sm text-gray-700 text-center">
                  <span className="font-medium">Thesis Title:</span> Comparison of Round Robin and Enhanced PSO Algorithms for Cloud Load Balancing Evaluating Response Time, Resource Utilization, and Energy Efficiency
                </p>
              </motion.div>
