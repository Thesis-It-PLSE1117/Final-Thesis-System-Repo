...
const SimulationPage = ({ onBack, initialTab = "dataCenter" }) => {
  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      setConfirmDialog({
        ...
        message:
          "We found a saved configuration from your last session. Would you like to restore it?",
        onConfirm: () => {
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-1.5 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Use the <strong>1k-tasks preset</strong> for optimal
                          performance online
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#319694] font-bold">•</span>
                        <span>
                          Run <strong>single iteration</strong> instead of
                          comparison mode for faster results
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#319694] font-bold">•</span>
                        <span>
                          ...
                          <strong>clone the repository</strong> and run locally
                        </span>
                      </li>
                    </ul>
                  </div>
  ...
  const renderConfigContent = () => (
    <>
      ...
      <main className="flex-grow p-4 md:p-5 overflow-y-auto">
        <TabContent
          activeTab={activeTab}
          direction={direction}
          config={config}
        ...
        return (
          ...
          >
            <AnimationTab
              ...
              acoResults={simulationResults?.baco}
              psoResults={simulationResults?.bpso}
  ...
  return (
    ...
    >
      ...
      {isSaving && (
        <div className="fixed bottom-3 left-3 bg-white shadow-lg px-3 py-1.5 rounded-lg text-sm">
          Saving...
        </div>
      )}
