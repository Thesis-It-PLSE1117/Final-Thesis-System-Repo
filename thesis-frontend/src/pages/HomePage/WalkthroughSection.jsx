...
} from "../../constants/metricsConfig.js";
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative">
          <div className="absolute left-8 top-0 h-full w-1 bg-gradient-to-b from-[#319694] to-[#4fd1c5]"></div>
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full mb-4 shadow-inner border border-[#319694]/20">
              ...
              <span className="text-sm font-semibold text-[#267b79]">
                Performance Metrics
              </span>
            </div>
